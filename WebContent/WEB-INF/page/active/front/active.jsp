...
<head>
    ...
    <script src="/themes/dj/js/front/active.js"></script>
...
<body>
	...
	<div class="smallTitle"><img src="/themes/dj/img/activity_title.png" /></div>
	<ul class="activity-sel">
        <li><select class="segment-select" id="type" onchange="setType();" ></select></li>
        <li><select  id="address" onchange="setType();" ></select></li>
        <li><select  id="month" onchange="setType();" ></select></li>
    </ul>
    <section class="activity-list" id="activeDiv" >
        <div class="activity-item" v-for="model in actives"   onclick="goUrl('/active/page/detail.html?id={{model.id}}')"    >
            <img v-bind:src="model.topImg" class="activity-banner" />
            <div class="data"><img src="/themes/dj/img/data_label.png" /><p v-text="model.detailImg" ></p></div>
        </div>
    </section>
</body>
</html>