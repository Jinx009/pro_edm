      ...
      <section id="content">
        <section class="panel  panel-1 panel-default">
           ...
           <div class="row text-sm wrapper">
            <div>
            	 <select class="form-control m-b" style="display: inline-block;width: 150px;" id="search_type" >
            	 	 <option value="" >请选择</option>
            	 	 <option value="电音">活动类型-电音</option>
	            	 <option value="Night Club">活动类型-Night Club</option>
	            	 <option value="电音新闻">资讯类型-电音新闻</option>
	            	 <option value="电音八卦">资讯类型-电音八卦</option>
	            	 <option value="世界TOP100 DJ">世界TOP100 DJ-世界TOP100 DJ</option>
	            	 <option value="世界TOP100 Club">世界TOP100 Club-世界TOP100 Club</option>
            	 </select>
            	 <input  type="text" class="form-control  m-b"  style="display: inline-block;width: 150px;"  placeholder="关键字" value="" id="search_key">
                <a class="btn btn-s-md btn-danger btn-rounded m-b"  style="display: inline-block;width: 150px;"   onclick="loadData();">筛选</a>
              </div>
              <div>
          ...
          <div class="panel-body">
            <form role="form">
              ...
              <div class="form-group">
                <label>名称</label>
                <input  type="text" class="form-control" placeholder="名称" value="" id="active_name">
              </div>
              <div class="form-group">
                <label>排序</label>
                <input  type="text" class="form-control" placeholder="排序" value="" id="orderNum">
              </div>
              <div class="form-group">
                <label>类型</label>
                <select class="form-control m-b" id="active_type" onchange="changeType()" ><option>请选择</option></select>
              </div>
...
<script src="/themes/active/js/activeList.js?version=1.02"></script>
